    ...
    <form class="form" method="post" action="viewMain.php">
        ...
        <div class='row'>
            ...
            <div class='col-sm-3' style="text-align: center">
                <input type="image" name="acao" value="aluno/" src="../../recursos/img/menu_aluno.png" />
            </div>

            <div class='col-sm-3' style="text-align: center">
                <input type="image" name="acao" value="evento/" src="../../recursos/img/menu_evento.png" />
            </div>

            <div class='col-sm-3' style="text-align: center">
                <input type="image" name="acao" value="certificado/" src="../../recursos/img/menu_certificado.png" />
            </div>
