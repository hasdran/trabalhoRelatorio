    ...
    class controleEvento {
        ...
        public static function rota() {
            ...
            if(strcmp($dados[0], "vincular") == 0) {
                echo "<script>window.location='../view/viewEventoVincular.php?evento=".$dados[1]."'</script>";
            }
            ...
            while($objEvento = $eventos->fetchObject()) {
            	...
            	echo "<tr>";
					...
					echo "<td>";
						...
						echo "</button>";
                        echo "&nbsp";
						echo "<button type='submit' name='acao' value='vincular/$objEvento->nome&$objEvento->id".$objEvento->id."'>";
