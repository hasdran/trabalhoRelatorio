<?php
    ...
    class controleAluno {
        ...
        public static function loadTabelaVincularAlunos() {
            ...
            while($objAluno = $alunos->fetchObject()) {
                ...
                echo "<tr>";
                    echo "<td><input type='checkbox' class='form-check-input' name='ck_$objAluno->id'  id='ck_$objAluno->id'>";
                    echo "&nbsp;&nbsp;";
                    echo "<label id='lb_$objAluno->id' style='color: red'>NÃO</label>";
                    echo "</td>";
                    echo "<td>".$objAluno->nome."</td>";
                    echo "<td>".$objAluno->curso."</td>";
                    echo "<td>".$objAluno->turma."</td>";
