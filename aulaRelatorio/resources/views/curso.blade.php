...
<div class='row'>
    <div class='col-sm-8' style="text-align: center">
        <a  href="{{ action('Curso@cadastrar') }}" type="button" class="btn btn-primary btn-block">
...
<table class='table table-striped'>
    ...
    @foreach ($cursos as $dados)
        <tr>
            ...
            <td>
                <a href="{{ action('Curso@editar', ['id' => $dados->id]) }}"><span class='glyphicon glyphicon-pencil'></span></a>
                &nbsp;
                <a href="{{ action('Curso@remover', ['id' => $dados->id]) }}"><span class='glyphicon glyphicon-remove'></span></a>
            </td>
