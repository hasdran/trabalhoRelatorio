...
<div class='row'>
    <div class='col-sm-8' style="text-align: center">
        <a  href="{{ action('Disciplina@cadastrar') }}" type="button" class="btn btn-primary btn-block">
    ...
    <table class='table table-striped'>
        ...
        @foreach ($disciplinas as $dados)
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <a  href="{{ action('Conteudo@cadastrar', $dados->id) }}" type="button" class="btn btn-primary">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            @foreach($conteudos as $data)
                                @if($data->id_disciplina == $dados->id)
                                    ...
                                    <li>
                                        <a href="{{ action('Conteudo@editar', $data->id) }}">
                                            @if($data->ativo == 1)
                ...
                <td>
                    <div class="btn-group">
                        <a  href="{{ action('Atividade@cadastrar', $dados->id) }}" type="button" class="btn btn-primary">
                            <span class='glyphicon glyphicon-plus'></span>
                        </a>
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <span class="caret"></span>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            @foreach($atividades as $data)
                                @if($data->id_disciplina == $dados->id)
                                    ...
                                    <li>
                                        <a href="{{ action('Atividade@editar', $data->id) }}">
                                            @if($data->ativo == 1)
                ...
                <td>
                    <a href="{{ action('Disciplina@editar', $dados->id) }}"><span class='glyphicon glyphicon-pencil'></span></a>
                    &nbsp;
                    <a href="{{ action('Disciplina@remover', $dados->id) }}"><span class='glyphicon glyphicon-remove'></span></a>
                    &nbsp;
                    <a href="{{ action('Peso@editar', $dados->id) }}"><span class='glyphicon glyphicon-education'></span></a>
                </td>
        @endforeach
        </tbody>
    </table>
